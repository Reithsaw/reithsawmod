...
import be.reithsaw.reithsawmod.tileentity.ElectrifierTile;
...
public class Electrifier extends Block
{
            ...
            if (tileEntity instanceof ElectrifierTile)
            {
                INamedContainerProvider containerProvider = new INamedContainerProvider() {
                    ...
                    public ITextComponent getDisplayName() {
                        return new TranslationTextComponent("screen.reithsawmod.electrifier");
                    }
    ...
    {
        return ModTileEntities.ELECTIFIER_TILE_ENTITY.get().create();
    }
